            ...
            for action2 in range(action1 + 1, 4):
                ...
                # PWM0
                    ...
                    cov_points.append(CoverPoint(
                        ...
                        xf=lambda tr, action1 = action1, action2 = action2: ((self.regs.read_reg_value("CFG") & 0b11)==0b10 , self.is_action_present(self.regs.read_reg_value("PWM0CFG"), action1, DownCount=False) , self.is_action_present(self.regs.read_reg_value("PWM0CFG"), action2, DownCount=False)),
                        bins=[ (True , True, True) ],
                    ...
                    cov_points.append(CoverPoint(
                        ...
                        xf=lambda tr, action1 = action1, action2 = action2: ((self.regs.read_reg_value("CFG") & 0b11)==0b01 , self.is_action_present(self.regs.read_reg_value("PWM0CFG"), action1, DownCount=True) , self.is_action_present(self.regs.read_reg_value("PWM0CFG"), action2, DownCount=True)),
                        bins=[ (True, True, True) ],
                        bins_labels=[(f"{action1_label}" , f"{action2_label}")],
                        # at_least=3,
                        rel=lambda val , b : val[0]==b[0] and val[1]==b[1] and val[2]==b[2]
                    ...
                    cov_points.append(CoverPoint(
                        ...
                        xf=lambda tr, action1 = action1, action2 = action2: ((self.regs.read_reg_value("CFG") & 0b11)==0b11 , self.is_action_present(self.regs.read_reg_value("PWM0CFG"), action1, DownCount=False) , self.is_action_present(self.regs.read_reg_value("PWM0CFG"), action2, DownCount=False)),
                        bins=[ (True, True, True) ],
                        bins_labels=[(f"{action1_label}" , f"{action2_label}")],
                        # at_least=3,
                        rel=lambda val , b : val[0]==b[0] and val[1]==b[1] and val[2]==b[2]
                ...
                # PWM1
                    ...
                    cov_points.append(CoverPoint(
                        ...
                        xf=lambda tr, action1 = action1, action2 = action2: ((self.regs.read_reg_value("CFG") & 0b11)==0b10 , self.is_action_present(self.regs.read_reg_value("PWM1CFG"), action1, DownCount=False) , self.is_action_present(self.regs.read_reg_value("PWM1CFG"), action2, DownCount=False)),
                        bins=[ (True, True, True) ],
                        bins_labels=[(f"{action1_label}" , f"{action2_label}")],
                        # at_least=3,
                        rel=lambda val , b : val[0]==b[0] and val[1]==b[1] and val[2]==b[2]
                    ...
                    cov_points.append(CoverPoint(
                        ...
                        xf=lambda tr, action1 = action1, action2 = action2: ((self.regs.read_reg_value("CFG") & 0b11)==0b01 , self.is_action_present(self.regs.read_reg_value("PWM1CFG"), action1, DownCount=True) , self.is_action_present(self.regs.read_reg_value("PWM1CFG"), action2, DownCount=True)),
                        bins=[ (True, True, True) ],
                        bins_labels=[(f"{action1_label}" , f"{action2_label}")],
                        # at_least=3,
                        rel=lambda val , b : val[0]==b[0] and val[1]==b[1] and val[2]==b[2]
                    ...
                    cov_points.append(CoverPoint(
                        ...
                        xf=lambda tr, action1 = action1, action2 = action2: ((self.regs.read_reg_value("CFG") & 0b11)==0b11 , self.is_action_present(self.regs.read_reg_value("PWM1CFG"), action1, DownCount=False) , self.is_action_present(self.regs.read_reg_value("PWM1CFG"), action2, DownCount=False)),
                        bins=[ (True, True, True) ],
                        bins_labels=[(f"{action1_label}" , f"{action2_label}")],
                        # at_least=3,
                        rel=lambda val , b : val[0]==b[0] and val[1]==b[1] and val[2]==b[2]
